...
$("._show-book").click(function () {
    // document.body.scrollTop = document.documentElement.scrollTop = 0;
    $(".book-reader").addClass("_open")
    $("body").addClass("fixed-body")
})

$("._close-book").click(function () {
    $(".book-reader").removeClass("_open")
    $("body").removeClass("fixed-body")
    if($(this).parents("#container").hasClass("flipbook-browser-fullscreen")){
